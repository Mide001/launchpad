      ...
      >
        ...
        <s.Container fd="row">
          <s.Container ai="center" flex={1}>
           ...
           <s.TextBlack> {BigNumber(contract.web3.utils.fromWei(idoInfo.softCap)).toFormat(
              2
            ) +
              " " +
              process.env.REACT_APP_CURRENCY} </s.TextBlack>
          </s.Container>
          <s.Container ai="center" flex={1}>
            <s.TextID fullWidth>Hard Cap</s.TextID>
           <s.TextBlack> {BigNumber(contract.web3.utils.fromWei(idoInfo.hardCap)).toFormat(
              2
            ) +
              " " +
              process.env.REACT_APP_CURRENCY}</s.TextBlack>
