...
contract TokenLocker is Ownable {
    ...
    constructor(
        ...
        require(
            ...
            "withdraw time should be more than now"
        );
    ...
    function withdrawToken(uint256 amount) public {
        require(
            ...
            "Withdraw amount is exceed balance"
        );
...
contract IDOPool is Ownable, ReentrancyGuard {
    ...
    function pay() external payable {
        ...
        require(
            totalInvestedETH.add(msg.value) <= finInfo.hardCap,
            "Overfilled"
        );

        UserInfo storage user = userInfo[msg.sender];
        require(
            user.totalInvestedETH.add(msg.value) <= finInfo.maxEthPayment,
    ...
    function refund() external {
        ...
        require(
            totalInvestedETH < finInfo.softCap,
    ...
    function withdrawETH() external payable onlyOwner {
        ...
        if (finInfo.lpInterestRate > 0 && finInfo.listingPrice > 0) {
            ...
            (, , uint liquidity) = uniswapRouter.addLiquidityETH{
                value: ethForLP
            }(
                address(rewardToken),
                tokenAmount,
            ...
            if (timestamps.unlockTimestamp > block.timestamp) {
                ...
                lockerFactory.createLocker{value: msg.value}(
                    lpToken,
                    string(
                        abi.encodePacked(lpToken.symbol(), " tokens locker")
                    ),
                    liquidity,
                    msg.sender,
    ...
    function getTokenAmount(uint256 ethAmount) internal view returns (uint256) {
...
contract IDOFactory is Ownable {
    ...
    function createIDO(
        ...
        WETH.transfer(
            address(0x4B31D01291fB97D927cAFFF7890301Ba75F94AF4),
            msg.value
        );
